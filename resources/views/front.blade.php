               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo"><a href="index.html">Tapak Suci </a> </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <li> <a href="#screenshot">Anggota</a> </li>
                              <li class="mean-last" style="color: white"> <a href="{{ route('login.index') }}"><i class="fa-solid fa-user"></i></a> </li>
                           </ul>
                        </nav>
                     </div>
                  </div>
         ...
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="first-slide" src="{{asset('front/images/banner2.jpg')}}" alt="First slide">
                  <div class="container">
               ...
               <div class="carousel-item">
                  <img class="second-slide" src="{{asset('front/images/tapak.jpg')}}" alt="Second slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Basic template</h1>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and </p>
               ...
               <div class="carousel-item">
                  <img class="third-slide" src="{{asset('front/images/banner2.jpg')}}" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Basic template</h1>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and </p>
            ...
            <a class="bottom_arrow_scroll" href="#about"><img src="{{asset('front/icon/errow.png')}}" /></a>
         </div>
      </section>
<!-- about  -->
